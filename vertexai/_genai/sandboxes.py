...
class Sandboxes(_api_module.BaseModule):
    ...
    def _create(
        ...
        *,
        ...
        sandbox_environment_snapshot: Optional[str] = None,
    ...
    def snapshots(self) -> Any:
        if self._snapshots is None:
            try:
                self._snapshots = importlib.import_module(
                    ".sandbox_snapshots", __package__
                )
            except ImportError as e:
                raise ImportError(
                    "The agent_engines.sandboxes.snapshots module requires additional packages. "
