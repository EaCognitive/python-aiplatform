...
class A2aAgent:
    ...
    def __init__(
        ...
        *,
        ...
        if not _is_version_enabled(agent_card, "1.0"):
            raise ValueError(
    ...
    def _get_handler(self, kwargs: dict[str, Any]) -> Any:
        handler = kwargs.get("request_handler", getattr(self, "request_handler", None))
        if not handler:
    ...
    async def extended_agent_card(
        ...
        **kwargs,
        ...
        return await self._get_handler(kwargs).handle_authenticated_agent_card(
            request, context
        )
    ...
    def register_operations(self) -> Dict[str, List[str]]:
        ...
        if (
            ...
            routes["a2a_extension"].append("extended_agent_card")
        return routes
